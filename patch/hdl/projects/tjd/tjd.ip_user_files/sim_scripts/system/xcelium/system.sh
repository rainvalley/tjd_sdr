...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../bd/system/ipshared/a40c" \
       +incdir+"$ref_dir/../../../../tjd.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../tjd.gen/sources_1/bd/system/ipshared/ee60/hdl" \
       +incdir+"../../../../tjd.gen/sources_1/bd/system/ipshared/a40c" \
       +incdir+"../../../../tjd.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../tjd.gen/sources_1/bd/system/ipshared/ee60/hdl" \
